<template>
  <div class="index-container">
    ...
    <el-row>
      <el-button class="export-it" type="primary" @click="handleAdd()">Add metrics</el-button>
      <el-table
        ref="tableSort"
...
<!--        <el-table-column label="BMI" prop="BMI" show-overflow-tooltip />-->
        ...
        <el-table-column label="Body Metrics Name" prop="index_console" show-overflow-tooltip />
        <el-table-column label="Metrics Query" prop="index_query" show-overflow-tooltip />
        <el-table-column label="Metrics Unit" prop="index_unit" show-overflow-tooltip />
    ...
    >
      <el-form ref="form" label-width="150px" :model="form" :rules="rules">
        <el-form-item label="Body Metrics Name" prop="index_console">
          <el-input v-model.trim="form.index_console" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Metrics Query" prop="index_query">
          <el-input v-model.trim="form.index_query" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Metrics Unit" prop="index_unit">
          <el-input v-model.trim="form.index_unit" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Min Number" prop="min_num">
          <el-input v-model.trim="form.min_num" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Max Number" prop="max_num">
          <el-input v-model.trim="form.max_num" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Scale" prop="scale">
          <el-input v-model.trim="form.scale" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Average" prop="average">
          <el-input v-model.trim="form.average" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Metrics Name" prop="index_name">
          <el-input v-model.trim="form.index_name" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Is Circadian" prop="is_circadian">
          <el-input v-model.trim="form.is_circadian" autocomplete="off" />
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    save() {
      this.$refs['form'].validate(async (valid) => {
        if (valid) {
          const { msg } = await EditBodyIndexType(this.form)
