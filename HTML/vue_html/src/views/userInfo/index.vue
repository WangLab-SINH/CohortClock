...
<!--        <el-table-column label="Group Type" prop="group_type" show-overflow-tooltip />-->
        <el-table-column label="Eating Start Time" prop="start_time" show-overflow-tooltip />
        <el-table-column label="Eating End Time" prop="end_time" show-overflow-tooltip />
        <el-table-column label="Eating Time Control" prop="edit_flag" show-overflow-tooltip />
...
<!--        <el-table-column label="Uploaded Metrics Number" prop="body_index_num" show-overflow-tooltip />-->
...
<!--        <el-table-column label="BMI" prop="BMI" show-overflow-tooltip />-->
    ...
    >
      <el-form ref="form" label-width="150px" :model="form" :rules="rules">
        <el-form-item label="Eating start time" prop="start_time">
          <el-input v-model.trim="form.start_time" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Eating end time" prop="end_time">
          <el-input v-model.trim="form.end_time" autocomplete="off" />
        </el-form-item>
        <el-form-item label="Edit flag true or false" prop="edit_flag">
          <el-input v-model.trim="form.edit_flag" autocomplete="off" />
        </el-form-item>
      </el-form>
...
import { EditEatFlag, GetUserinfolist, PressureInfoData } from "@/api/photoPage";
  ...
  methods: {
    ...
    save() {
      this.$refs['form'].validate(async (valid) => {
        if (valid) {
          const { msg } = await EditEatFlag(this.form)
    ...
    async fetchData() {
      ...
      //   this.listLoading = false
      // })
      GetUserinfolist(this.queryForm.pageNo, this.queryForm.pageSize).then(res => {
