...
<!--        <dot-chart></dot-chart>-->
      ...
      <table>
        <tr>
          <fieldset id="downbox">
              ...
              <div class="div1">
                <multiselect v-model="checkbox_majorclass" @close="handleMajorClassChange"  @remove="hanleMajorClassRemove" :close-on-select="false" :clear-on-select="false" :preserve-search="true" :options="major_class_list" :multiple="false"  placeholder="Type to search" track-by="index_name" label="index_name"><span slot="noResult">Oops! No elements found. Consider changing the search query.</span></multiselect>
              </div>
            </fieldset>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column label="Data Timestamp" prop="data_time" show-overflow-tooltip />
        <el-table-column label="Kind of Body Metrics" prop="index_name" show-overflow-tooltip />
        <el-table-column label="Body Metrics Value" prop="index_value" show-overflow-tooltip />
...
import { BodyIndexData, PhotoInfoData } from "@/api/photoPage";
import { dependencies, devDependencies } from '../../../package.json'
// import { getList } from '@/api/changeLog'
import { getNoticeList } from '@/api/notice'
import { doDelete, getList } from '@/api/table'
import DotChart from '@/views/bodyIndex/DotChart.vue'
...
export default {
  ...
  methods: {
    ...
    handleMajorClassChange (value) {
      if(value != null){
        this.select_body_index = value.index_name
        this.fetchData()
      }
    ...
    async fetchData() {
      ...
      //   this.listLoading = false
      // })
      BodyIndexData(this.select_body_index, this.queryForm.pageNo, this.queryForm.pageSize).then(res => {
        ...
        this.listLoading = false
        this.major_class_list = res.data.index_name
      })
