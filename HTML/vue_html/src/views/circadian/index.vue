...
<!--      </el-col>-->
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column label="Metrics Value" prop="index_value" show-overflow-tooltip />
        <el-table-column label="Metrics Name" prop="index_name" show-overflow-tooltip />
        <el-table-column label="AMP" prop="AMP" show-overflow-tooltip />
        <el-table-column label="Pvalue" prop="Pvalue" show-overflow-tooltip />
        <el-table-column label="Period" prop="Period" show-overflow-tooltip />
        <el-table-column label="Phase Time" prop="Phase_time" show-overflow-tooltip />
