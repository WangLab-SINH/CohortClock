    ...
    children: [
      {
        path: 'bodyIndex',
        name: 'BodyIndex',
        component: '@/views/bodyIndex/index',
        meta: {
          title: 'Body Metrics',
          icon: 'bug',
          affix: true,
    ...
    children: [
      {
        path: 'userInfo',
        name: 'UserInfo',
        component: '@/views/userInfo/index',
        meta: {
          title: 'User Info',
          icon: 'bug',
          affix: true,
    ...
    children: [
      {
        path: 'circadian',
        name: 'circadian',
        component: '@/views/circadian/index',
        meta: {
          title: 'Rhythmic Parameters',
          icon: 'bug',
          affix: true,
        },
      },
    ...
    children: [
      {
        path: 'add_index',
        name: 'add_index',
        component: '@/views/add_index/index',
        meta: {
