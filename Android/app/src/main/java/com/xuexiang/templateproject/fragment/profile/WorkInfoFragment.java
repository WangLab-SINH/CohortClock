...
@Page(name = "Work Time",anim = CoreAnim.none)
public class WorkInfoFragment extends BaseFragment{
    ...
    protected int getLayoutId() {
        return R.layout.fragment_info_work;
    }
...
//    }
    private void initTabControlView() {
        try {
            mTabControlView.setItems(ResUtils.getStringArray(R.array.course_param_option2),ResUtils.getStringArray(R.array.course_param_option2));
