...
public class ShareUtils {
    ...
    public static void sharePhoto(final Activity activity, Bitmap photo, String title, String description, String imageUrl, int imageID, SHARE_MEDIA platform) {
        UMImage image = new UMImage(activity, photo);//本地文件
//        UMImage thumb =  new UMImage(activity, imageID);
