...
//  FWSideMenu
//
//  Created by wanglab on 2020/11/11.
...
//                let attribute:Dictionary = [NSAttributedString.Key.font:TextRulerFont,NSAttributedString.Key.foregroundColor:UIColor.init(white: TextColorWhiteAlpha, alpha: 1.0)]
                ...
                let attribute:Dictionary = [NSAttributedString.Key.font:TextRulerFont,NSAttributedString.Key.foregroundColor:UIColor.gray]
...
//        zyValueTF.defaultTextAttributes     = [NSAttributedString.Key.font.rawValue:UIFont.systemFont(ofSize: 19)]
    ...
    lazy var lazyOKBtn:UIButton = {
        ...
        okBtn.setTitleColor(UIColor.gray, for: UIControl.State.normal)
    ...
    lazy var lazyTriangle: DYTriangleView = {
        ...
        triangleView.triangleColor = UIColor.green
        return triangleView
    }()
