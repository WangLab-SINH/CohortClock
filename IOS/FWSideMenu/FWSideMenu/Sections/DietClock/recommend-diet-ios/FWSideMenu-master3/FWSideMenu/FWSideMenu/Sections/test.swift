...
//  FWSideMenu
//
//  Created by wanglab on 2020/11/10.
...
class testController: UIViewController, NMMultiUnitRulerDataSource, NMMultiUnitRulerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.colorSwitch?.addTarget(self,
                                    action: #selector(testController.colorSwitchValueChanged(sender:)),
                                    for: .valueChanged)
        self.directionSwitch?.addTarget(self,
                                        action: #selector(testController.directionSwitchValueChanged(sender:)),
                                        for: .valueChanged)
        self.moreMarkersSwitch?.addTarget(self,
                                          action: #selector(testController.moreMarkersSwitchValueChanged(sender:)),
                                          for: .valueChanged)
