...
//        NotificationCenter.default.addObserver(self, selector: #selector(self.statusBarOrientationChange), name: NSNotification.Name.UIApplication.didChangeStatusBarOrientationNotification, object: nil)
//        
//    }
    // 屏幕旋转时移除pickerView
