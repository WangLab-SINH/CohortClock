...
//    }()
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundImage = AppDelegate.resizableImage(imageName: (kStatusBarHeight > 20) ? "tabbar_bg_X" : "tabbar_bg", edgeInsets: UIEdgeInsets(top: 0.1, left: 0, bottom: 0, right: 0))
    }
...
//    lazy var animateImageView0: UIImageView = {
//
//        let animateImageView = UIImageView(image: UIImage(named: "trending_photo_ios_new"))
//        self.addSubview(animateImageView)
//        return animateImageView
//    }()
//    lazy var animateImageView1: UIImageView = {
    ...
    @objc func tabBarBtnAction(bar: UIControl) {
        ...
        for imageView in bar.subviews {
            if imageView.isKind(of: NSClassFromString("UITabBarSwappableImageView")!) {
               ...
               // animatCAAnimationCalculationMode.cubicde = kCAAnimationCubic
       ...
       // switch bar.tag {
//        case 0:
//            self.animateImageView0.image = UIImage(named: "trending_photo_ios_new")
//            self.animateImageView1.image = UIImage(named: "trending_photo_ios_new")
//            self.animateImageView2.image = UIImage(named: "trending_photo_ios_new")
//            self.animateImageView3.image = nil
//            break
//        case 1:
//            self.animateImageView0.image = UIImage(named: "trending_photo_ios_new")
...
//            self.animateImageView1.image = UIImage(named: "trending_photo_ios_new")
//            self.animateImageView2.image = UIImage(named: "trending_photo_ios_new")
//            self.animateImageView3.image = UIImage(named: "trending_photo_ios_new")
//            break
//        default:
//            break
